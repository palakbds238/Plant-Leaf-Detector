...
with st.sidebar:
    ...
    st.header("Credits")
    st.write("Built by:")
    st.write("- **Vanshika Maru**")
    st.write("- **Palak Bordiya**")
    st.write("- **Apurva Sethiya**")
    st.write("- **Sakshi Goyal**")
    st.write("Tech Stack: Streamlit, TensorFlow, OpenCV, Pillow, MobileNetV2")
    st.markdown("---")
...
with right:
    ...
    if image is not None:
        st.image(image, caption="Input Leaf")
